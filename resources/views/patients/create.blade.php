        ...
        <div class="d-flex flex-column flex-lg-row-fluid w-50 p-10 order-2 order-lg-1">
            ...
            <div class="d-flex flex-center flex-column flex-lg-row-fluid">
                ...
                <div class="container-fluid card p-5">
                    <!--begin::Form-->
                    <form class="form" action="{{ route('patients.store') }}" method="POST" novalidate="novalidate">
                        @csrf
                        <!--begin::Heading-->
                        <div class="text-center mb-11">
                            <!--begin::Title-->
                            <h1 class="text-dark fw-bolder mb-3">Add New Patient</h1>
                            <!--end::Title-->
                        </div>
                        <!--begin::Heading-->
                        <!--begin::Separator-->
                        ...
                        <div class="fv-row mb-8">
                            <!--begin::email-->
                            <input type="email" placeholder="email" name="email" id="name" autocomplete="off"
                                class="form-control bg-transparent" />
                            <!--end::email-->
                        </div>
                        <!--end::Input group=-->
                        ...
                        <div class="fv-row mb-8">
                            <!--begin::password-->
                            <input type="password" placeholder="password" name="password" id="name" autocomplete="off"
                                class="form-control bg-transparent" />
                            <!--end::password-->
                        </div>
                        <!--end::Input group=-->
                        ...
                        <div class="fv-row mb-8">
                            <!--begin::phoneNumber-->
                            <input type="tel" placeholder="phoneNumber" name="phoneNumber" id="name"
                        ...
                        <div class="fv-row mb-8">
                            <!--begin::age-->
                            <input type="number" placeholder="age" name="age" id="name" autocomplete="off"
                                class="form-control bg-transparent" />
                            <!--end::age-->
                        </div>
                        <!--end::Input group=-->
                        ...
                        <div class="fv-row mb-8">
                            ...
                            <textarea placeholder="problem" name="problem" class="form-control bg-transparent" rows="5" cols="12"></textarea>
